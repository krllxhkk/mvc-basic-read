        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/HorlogeController/create" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="prijs" type="number" min="0" max="999999" step="1" class="form-control <?= isset($data['errors']['prijs']) ? 'is-invalid' : ''; ?>" id="prijs" value="<?= $_POST['prijs'] ?? ''; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="omschrijving" type="text" class="form-control <?= isset($data['errors']['omschrijving']) ? 'is-invalid' : ''; ?>" id="omschrijving" value="<?= $_POST['omschrijving'] ?? ''; ?>">
